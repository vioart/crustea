      ...
      <div className="relative mx-auto max-w-7xl px-5 py-20 sm:py-24 lg:px-8 lg:py-28">
        ...
        <div className="service-line relative mt-16 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
          {services.map((service) => (
            <article
              key={service.number}
              className="relative flex min-h-[350px] flex-col rounded-[24px] border border-border bg-background p-6 pt-10 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md"
            >
              {/* =================================================
                  STEP NUMBER
              ================================================= */}
